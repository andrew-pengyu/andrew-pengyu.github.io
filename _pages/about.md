...
Pengyu Zhu (朱鹏宇) is currently a Master’s student in Artificial Intelligence at North China Electric Power University ([NCEPU](https://www.ncepu.edu.cn/)), working closely with [Prof. Bing Li](https://people.ucas.edu.cn/~bingli) from the Institute of Automation, Chinese Academy of Sciences ([CASIA](http://www.ia.ac.cn)). He is a member of The Chinese Association for Artificial Intelligence(中国人工智能学会) and The China Society of Image and Graphics(中国图像图形学会). His research focuses on Pattern Recognition, Time Series Foundational Model, AI for science, and Brain-Computer Interfaces. 
